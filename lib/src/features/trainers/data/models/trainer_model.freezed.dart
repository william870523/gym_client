...
@JsonKey(name: 'id_entrenador') String get id;@JsonKey(name: 'ci_entrenador') String get ci;@JsonKey(name: 'nombres_entrenador') String? get nombres;@JsonKey(name: 'apellidos_entrenador') String? get apellidos;@JsonKey(name: 'sexo_entrenador') String? get sexo;@JsonKey(name: 'foto_entrenador') String? get foto;@JsonKey(name: 'direccion_entrenador') String? get direccion;@JsonKey(name: 'telefono_entrenador') int? get telefono;@JsonKey(name: 'correo_entrenador') String? get correo;@JsonKey(name: 'activo_entrenador') bool get activo;@JsonKey(name: 'fecha_incio_entrenador') DateTime get fechaInicio;@JsonKey(name: 'version') int? get version;@JsonKey(name: 'gym_id') String? get gymId;@JsonKey(name: 'is_deleted') bool get isDeleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ci,nombres,apellidos,sexo,foto,direccion,telefono,correo,activo,fechaInicio,version,gymId,isDeleted);

@override
String toString() {
  return 'TrainerModel(id: $id, ci: $ci, nombres: $nombres, apellidos: $apellidos, sexo: $sexo, foto: $foto, direccion: $direccion, telefono: $telefono, correo: $correo, activo: $activo, fechaInicio: $fechaInicio, version: $version, gymId: $gymId, isDeleted: $isDeleted)';
}
...
/// Create a copy of TrainerModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? ci = null,Object? nombres = freezed,Object? apellidos = freezed,Object? sexo = freezed,Object? foto = freezed,Object? direccion = freezed,Object? telefono = freezed,Object? correo = freezed,Object? activo = null,Object? fechaInicio = null,Object? version = freezed,Object? gymId = freezed,Object? isDeleted = null,}) {
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id_entrenador')  String id, @JsonKey(name: 'ci_entrenador')  String ci, @JsonKey(name: 'nombres_entrenador')  String? nombres, @JsonKey(name: 'apellidos_entrenador')  String? apellidos, @JsonKey(name: 'sexo_entrenador')  String? sexo, @JsonKey(name: 'foto_entrenador')  String? foto, @JsonKey(name: 'direccion_entrenador')  String? direccion, @JsonKey(name: 'telefono_entrenador')  int? telefono, @JsonKey(name: 'correo_entrenador')  String? correo, @JsonKey(name: 'activo_entrenador')  bool activo, @JsonKey(name: 'fecha_incio_entrenador')  DateTime fechaInicio, @JsonKey(name: 'version')  int? version, @JsonKey(name: 'gym_id')  String? gymId, @JsonKey(name: 'is_deleted')  bool isDeleted)?  $default,) {final _that = this;
switch (_that) {
case _TrainerModel() when $default != null:
return $default(_that.id,_that.ci,_that.nombres,_that.apellidos,_that.sexo,_that.foto,_that.direccion,_that.telefono,_that.correo,_that.activo,_that.fechaInicio,_that.version,_that.gymId,_that.isDeleted);case _:
  return null;
...
class _TrainerModel implements TrainerModel {
  const _TrainerModel({@JsonKey(name: 'id_entrenador') required this.id, @JsonKey(name: 'ci_entrenador') required this.ci, @JsonKey(name: 'nombres_entrenador') this.nombres, @JsonKey(name: 'apellidos_entrenador') this.apellidos, @JsonKey(name: 'sexo_entrenador') this.sexo, @JsonKey(name: 'foto_entrenador') this.foto, @JsonKey(name: 'direccion_entrenador') this.direccion, @JsonKey(name: 'telefono_entrenador') this.telefono, @JsonKey(name: 'correo_entrenador') this.correo, @JsonKey(name: 'activo_entrenador') required this.activo, @JsonKey(name: 'fecha_incio_entrenador') required this.fechaInicio, @JsonKey(name: 'version') this.version, @JsonKey(name: 'gym_id') this.gymId, @JsonKey(name: 'is_deleted') this.isDeleted = false});
...
/// Create a copy of TrainerModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ci = null,Object? nombres = freezed,Object? apellidos = freezed,Object? sexo = freezed,Object? foto = freezed,Object? direccion = freezed,Object? telefono = freezed,Object? correo = freezed,Object? activo = null,Object? fechaInicio = null,Object? version = freezed,Object? gymId = freezed,Object? isDeleted = null,}) {
