...
ClientModel _$ClientModelFromJson(Map<String, dynamic> json) => ClientModel(
  ...
  membershipVigencia: json['membresia_vigencia'] as String?,
  membershipDaysSinceExpiry: (json['membresia_dias_desde_vencimiento'] as num?)
      ?.toInt(),
  membershipCoversToday: json['membresia_cubre_hoy'] as bool?,
...
Map<String, dynamic> _$ClientModelToJson(ClientModel instance) =>
    <String, dynamic>{
      ...
      'membresia_vigencia': instance.membershipVigencia,
      'membresia_dias_desde_vencimiento': instance.membershipDaysSinceExpiry,
      'membresia_cubre_hoy': instance.membershipCoversToday,
